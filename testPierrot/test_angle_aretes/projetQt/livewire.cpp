...
double LiveWire::critere_angleEE(MyMesh* _mesh, EdgeHandle eh0, EdgeHandle eh1)
{
    QVector<QVector3D> points;
    QVector3D point_origine;

    VertexHandle vh0_edge0, vh1_edge0, vh0_edge1, vh1_edge1;
    UtilsMesh::get_vh_of_edge(_mesh, eh0.idx(), vh0_edge0, vh1_edge0);
    UtilsMesh::get_vh_of_edge(_mesh, eh1.idx(), vh0_edge1, vh1_edge1);
